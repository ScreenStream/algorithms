 ...
 * from the pile which has the maximum height and try to make it equal to the one which is just lower than
 * the maximum height of the stack. Determine the minimum number of steps required to make
 * all of the piles equal in height.
