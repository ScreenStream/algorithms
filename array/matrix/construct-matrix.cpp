...
/*
 * Given total numer of rows, columns, starting position and direction, construct a matrix of the given size and fill it
 * while moving in the given direction.
m -> row
n -> column
...
vector<vector<int>> constructMatrix(int n, int m, InitialPosition start, MovingDirection direction) {
    return {};
}