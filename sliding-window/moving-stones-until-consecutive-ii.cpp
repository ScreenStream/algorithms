...
/*
 * On an infinite number line, the position of the i-th stone is given by stones[i].  Call a stone an endpoint
 * stone if it has the smallest or largest position.
