...
You will initially start at the upper left cell (0,0). A valid path in the grid is a path which starts
...
The path to (3, 3) is as follows. (0, 0) --> (0, 1) --> (0, 2) --> (0, 3) change the arrow to down with
 ...
 cost = 1 --> (2, 0) --> (2, 1) --> (2, 2) --> (2, 3) change the arrow to down with
 cost = 1 --> (3, 3)
The total cost = 3.
